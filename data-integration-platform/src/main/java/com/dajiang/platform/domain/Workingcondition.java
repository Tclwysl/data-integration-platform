...
public class Workingcondition {
    ...
    @Column(name = "loadd", nullable = false, columnDefinition = "float(32,1) COMMENT '本次运行载重'")
    private Double loAdd;

    @Column(name = "loadPercent", nullable = false, columnDefinition = "float(32,1) COMMENT '本次运行最大载重百分比'")
    private Double  loadPErcent;

    @Column(name = "people_num", nullable = false, columnDefinition = "int(32) COMMENT '实时人数'")
    private Integer peoplenum;

    @Column(name = "startHeight", nullable = false, columnDefinition = "float(32,1) COMMENT '实时高度'")
    private Double  startHEight;

    @Column(name = "height_per", nullable = false, columnDefinition = "float(32,1) COMMENT '高度百分比'")
    ...
    @Column(name = "ti_lt", nullable = false, columnDefinition = "float(32,1) COMMENT '实时倾斜度'")
    private Double  tilt;
